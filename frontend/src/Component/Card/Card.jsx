...
const Card = ({ product,cardProductQuantity }) => {
  let {productComp,setLoginPanel, user, setUpdateProductPanel, setDeleteProductPanel, setProductComp, setLoaderPanel, setRefreshId, refreshId } = useContext(globalvar);
